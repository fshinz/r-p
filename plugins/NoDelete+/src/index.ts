...
// In‑memory maps for current session – cleared on unload
export const deletedMessages = new Map<string, { content: string; timestamp: string }>();
...
export default {
  onLoad() {
    try {
      ...
      // Intercept deletions (single & bulk)
      patches.push(
